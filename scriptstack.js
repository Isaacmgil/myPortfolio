document.addEventListener('DOMContentLoaded', function () {
    ...
    const technologies = [
        ...
        //HTML
        {
            ...
            `,
            customStyles: `
                .tech__card[data__tech="HTML"] .tech__name {
                    text-shadow: none !important;
                    border: 1px solid rgb(255, 123, 0) !important;
                }
                .tech__card[data-tech="HTML"]:hover .tech__logo {
                    filter: drop-shadow(0 0 5px rgb(255, 230, 0.6)) !important;
                }
                .tech__card[data__tech="HTML"] .tech__halo {
                ...
                .tech__card[data-tech="HTML"]:hover::before {
        ...
        //CSS
        {
            ...
            `,
            customStyles: `
                .tech__card[data-tech="CSS"] .tech__name {
                    text-shadow: none !important;
                    border: 1px solid rgb(0, 195, 221) !important;
                }
                .tech__card[data-tech="CSS"]:hover .tech__logo {
                    filter: drop-shadow(0 0 5px rgb(0, 195, 221)) !important;
                }
                .tech__card[data-tech="CSS"] .tech__halo {
                ...
                .tech__card[data-tech="CSS"]:hover::before {
        ...
        //JavaScript
        {
            ...
            `,
            customStyles: `
                .tech__card[data-tech="JavaScript"] .tech__name {
                    text-shadow: none !important;
                    border: 1px solid rgb(255, 230, 0) !important;
                }
                .tech__card[data-tech="JavaScript"]:hover .tech__logo {
                    filter: drop-shadow(0 0 5px rgb(255, 230, 0.6)) !important;
                }
                .tech__card[data-tech="JavaScript"] .tech__halo {
                ...
                .tech__card[data-tech="Angular"]:hover::before {
                    animation: borderGlowAngular 1.5s infinite alternate !important;
        ...
        //TypeScript
        {
            ...
            `,
            customStyles: `
                .tech__card[data-tech="TypeScript"] .tech__name {
                    text-shadow: none !important;
                    border: 1px solid rgba(97, 218, 251, 0.6) !important;
                }
                .tech__card[data-tech="TypeScript"]:hover .tech__logo {
                    filter: drop-shadow(0 0 5px rgba(0, 188, 221, 0.4)) !important;
                }
                .tech__card[data-tech="TypeScript"] .tech__halo {
                ...
                .tech__card[data-tech="TypeScript"]:hover::before {
        ...
        //Tailwind
        {
            ...
            `,
            customStyles: `
                .tech__card[data-tech="Tailwind"] .tech__name {
                    text-shadow: none !important;
                    border: 1px solid rgba(21, 177, 164, 0.6) !important;
                }
                .tech__card[data-tech="Tailwind"]:hover .tech__logo {
                    filter: drop-shadow(0 0 5px rgba(21, 177, 164, 0.4)) !important;
                }
                .tech__card[data-tech="Tailwind"] .tech__halo {
                ...
                .tech__card[data-tech="Tailwind"]:hover::before {
        ...
        //Visual Studio Code
        {
            ...
            `,
            customStyles: `
                .tech__card[data-tech="VisualStudio"] .tech__name {
                    text-shadow: none !important;
                    border: 1px solid rgba(4, 88, 136, 0.6) !important;
                }
                .tech__card[data-tech="VisualStudio"]:hover .tech__logo {
                    filter: drop-shadow(0 0 5px rgba(4, 88, 136, 0.4)) !important;
                }
                .tech__card[data-tech="VisualStudio"] .tech__halo {
                ...
                .tech__card[data-tech="VisualStudio"]:hover::before {
        ...
        //Angular
        {
            ...
            `,
            customStyles: `
                .tech__card[data-tech="Angular"] .tech__name {
                    text-shadow: none !important;
                    border: 1px solid rgba(221, 0, 49, 0.6) !important;
                }
                .tech__card[data-tech="Angular"]:hover .tech__logo {
                    filter: drop-shadow(0 0 5px rgba(221, 0, 49, 0.4)) !important;
                }
                .tech__card[data-tech="Angular"] .tech__halo {
        ...
        //NodeJS
        {
            ...
            `,
            customStyles: `
                .tech__card[data-tech="NodeJS"] .tech__name {
                    text-shadow: none !important;
                    border: 1px solid rgba(3, 109, 3, 0.6) !important;
                }
                .tech__card[data-tech="NodeJS"]:hover .tech__logo {
                    filter: drop-shadow(0 0 5px rgba(3, 109, 3, 0.4)) !important;
                }
                .tech__card[data-tech="NodeJS"] .tech__halo {
                ...
                .tech__card[data-tech="NodeJS"]:hover::before {
        ...
        //Git
        {
            ...
            `,
            customStyles: `
                .tech__card[data-tech="Git"] .tech__name {
                    text-shadow: none !important;
                    border: 1px solid rgba(221, 63, 0, 0.6) !important;
                }
                .tech__card[data-tech="Git"]:hover .tech__logo {
                    filter: drop-shadow(0 0 5px rgba(221, 63, 0, 0.4)) !important;
                }
                .tech__card[data-tech="Git"] .tech__halo {
                ...
                .tech__card[data-tech="Git"]:hover::before {
        ...
        //Terminal
        {
            ...
            customStyles: `
                ...
                .tech__card[data-tech="Terminal"]:hover::before {
        ...
        //Github
        {
            ...
            `,
            customStyles: `
                .tech__card[data-tech="Github"] .tech__name {
                    text-shadow: none !important;
                    border: 1px solid rgba(117, 117, 126, 0.6) !important;
                }
                .tech__card[data-tech="Github"]:hover .tech__logo {
                    filter: drop-shadow(0 0 5px rgba(117, 117, 126, 0.4)) !important;
                }
                .tech__card[data-tech="Github"] .tech__halo {
                ...
                .tech__card[data-tech="Github"]:hover::before {
    ...
    function createTechCard(tech) {
        ...
        haloElement.className = 'tech__halo';
