...
document.addEventListener('DOMContentLoaded', () => {
    projectsData.forEach(project => {
        ...
        const techListContainer = document.querySelector(`.tech__list[data-project-id="${project.id}"]`);
        ...
        if (techListContainer) {
            project.technologies.forEach(tech => {
                ...
                techItem.setAttribute('data-social', tech.name);
                techItem.style.setProperty('--accent-color', tech.accentColor);
                ...
                techItem.appendChild(svg);
                listItem.appendChild(techItem); 
                techListContainer.appendChild(listItem);
            });
